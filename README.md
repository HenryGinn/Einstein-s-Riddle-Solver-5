...
Multiple clues can be combined with logical OR. An example of this would be "Either the Brit drinks milk or the fish owner lives in the green house". It is possible for both of these to be true at once, but if the clue is formulated as an exclusive OR and only one of the options is allowed, then further constraints would be needed to disallow that possibility.
