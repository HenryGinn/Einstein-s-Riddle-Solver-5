...
class LinearProblem():
    ...
    display_rounding = 4
    output_rounding = 3
    display_tableau_bool = False
    display_basic_variables_bool = False
...
211 + 212 + 213 + 221 + 222 + 223 + 231 + 232 + 233 <= 1
311 + 312 + 313 + 321 + 322 + 323 + 331 + 332 + 333 <= 1
111 + 112 + 113 + 211 + 212 + 213 + 311 + 312 + 313 <= 1
121 + 122 + 123 + 221 + 222 + 223 + 321 + 322 + 323 <= 1
131 + 132 + 133 + 231 + 232 + 233 + 331 + 332 + 333 <= 1
111 + 121 + 131 + 211 + 221 + 231 + 311 + 321 + 331 <= 1
112 + 122 + 132 + 212 + 222 + 232 + 312 + 322 + 332 <= 1
113 + 123 + 133 + 213 + 223 + 233 + 313 + 323 + 333 <= 1
""")

a = [[sum((int(i) - 1) * j
          for i, j in zip(variable, [1, 3, 9]))
      for variable in line[:-4].split(" + ")]
     for line in constraints.split("\n")][1:-1]

A = np.zeros((len(a), 27))
for index, indices in enumerate(a):
    A[index, indices] = 1
...
values = np.zeros(prob.var_num)
values[prob.B] = prob.values
values = values[:27]
values = values.reshape(3, 3, 3)

names = [["Alice", "Bob", "Charlie"], ["A", "B", "C"], ["1", "2", "3"]]

for i in np.array(np.where(values > 0.1)).transpose():
    print(", ".join(names[j][i[j]] for j in range(3)))
